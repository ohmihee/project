...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ingcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ingcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ingcoin transaction") + "\n" +
              "  ingcoin-tx [options] -create [commands]   " + _("Create hex-encoded ingcoin transaction") + "\n" +
              "\n";
