...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1638996800, 129452, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("7b68b34eb3054fe8ccb69790232c1880220926c6b681db55a8e30a3ec4c4a71b"));
        assert(genesis.hashMerkleRoot == uint256S("0xc733692a5e3d40d7e6b7b070372567fcf39379de710c26cdbb07ff42d3d91fe4"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {  1500, uint256S("0x7b68b34eb3054fe8ccb69790232c1880220926c6b681db55a8e30a3ec4c4a71b")},
        ...
        chainTxData = ChainTxData{
            ...
            1638996800, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1638996765, 1652845, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7f49bc608fe94863960b2616c4d8ac3223138f98f998d8c89b30e8d5c438503a"));
        assert(genesis.hashMerkleRoot == uint256S("0xc733692a5e3d40d7e6b7b070372567fcf39379de710c26cdbb07ff42d3d91fe4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.ingcointools.com", true);
        vSeeds.emplace_back("seed-b.ingcoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x7f49bc608fe94863960b2616c4d8ac3223138f98f998d8c89b30e8d5c438503a")},
            }
        };
