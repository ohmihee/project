...
const char * const BITCOIN_CONF_FILENAME = "ingcoin.conf";
const char * const BITCOIN_PID_FILENAME = "ingcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "INGcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/INGcoin";
#else
    // Unix
    return pathRet / ".ingcoin";
#endif
#endif
}
